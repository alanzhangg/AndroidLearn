        ...
        switch (item.getItemId()){
            case R.id.new_crime:
                ...
                Intent intent = CrimePagerActivity
                        .newIntent(getActivity(), crime.getId(), CrimeLab.get(getActivity()).getCrimes().size() - 1);
...
//                    .show();
            mPotition = getAdapterPosition();
            Intent intent = CrimePagerActivity.newIntent(getActivity(), mCrime.getId(), mPotition);
            startActivity(intent);
        }
    }
